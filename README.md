...
1. Add submodule:
   ```bash
   git submodule add -b 18.0 https://github.com/OCA/web.git external_addons/web
   ```
...
**Base Image:** `borovlevas/odoo-base:18.0`
- Includes all Odoo 18.0 dependencies
- Python 3.11
...
Ensure your custom modules are compatible with Odoo 18.0.
